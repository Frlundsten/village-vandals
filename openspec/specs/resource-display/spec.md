...
How resource amounts advance locally between server syncs, mirroring the backend's accrual rule, and how the current village id is resolved for the views that need it.
