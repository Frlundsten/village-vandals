# Spec: Building Overview Panel

## Purpose

A dedicated panel accessible from the home sidebar that lists all constructed buildings in the player's current village, displays their levels, and allows the player to upgrade them when they can afford it.
