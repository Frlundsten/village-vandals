# Spec: Village Map Lifecycle

## Purpose

How the PixiJS village map mounts, resizes, and tears down without leaking, and how it reports load and action failures instead of leaving the player with a blank screen.
