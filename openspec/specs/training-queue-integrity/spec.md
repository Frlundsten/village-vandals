# Spec: Training Queue Integrity

## Purpose

Training orders are affordable, sanely bounded, scheduled no earlier than now, and placed only at a Barrack belonging to the village being trained for. Covers the arithmetic and scheduling rules that keep the queue from being exploitable.
