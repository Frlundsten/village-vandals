# Spec: Building Upgrade Costs

## Purpose

Define how each building type calculates its upgrade cost, ensuring costs are differentiated by building type and scale linearly with the target upgrade level.
